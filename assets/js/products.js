...
const NV_PRODUCTS = [
  {
    ...
    research: ["Incretin-receptor pharmacology", "Glucose-regulation pathways", "Adipose signalling"],
    specs: [
      { k: "Purity", v: "≥99% (HPLC)" },
  ...
  },
  {
    ...
    research: ["Incretin-receptor signalling", "Glucose homeostasis", "Receptor-binding assays"],
    specs: [
      { k: "Purity", v: "≥99% (HPLC)" },
  ...
  },
  {
    ...
    panel: "#EAEEF0",
    blurb:
      "The naturally occurring copper-binding tripeptide Gly-His-Lys complexed with Cu(II), a collagen-derived matrikine studied in extracellular-matrix and collagen-synthesis assays. Lyophilised, lot-tested, certificate of analysis in every vial.",
    research: ["Extracellular-matrix assays", "Collagen-synthesis assays", "Fibroblast-culture studies"],
    specs: [
      { k: "Purity", v: "≥98% (HPLC)" },
      { k: "CAS", v: "89030-95-5" },
  ...
  },
  {
    ...
    panel: "#EAEEF0",
    blurb:
      "The naturally occurring copper-binding tripeptide Gly-His-Lys complexed with Cu(II), a collagen-derived matrikine studied in extracellular-matrix and collagen-synthesis assays. The 100 mg presentation for extended protocols. Certificate of analysis in every vial.",
    research: ["Extracellular-matrix assays", "Collagen-synthesis assays", "Fibroblast-culture studies"],
    specs: [
      { k: "Purity", v: "≥98% (HPLC)" },
      { k: "CAS", v: "89030-95-5" },
  ...
  },
  {
    ...
    panel: "#EAEEF0",
    blurb:
      "A synthetic pentadecapeptide derived from a gastric protective protein, studied in cytoprotection, epithelial-barrier and angiogenesis assays. Lyophilised, ≥98% pure, with a certificate of analysis in every vial.",
    research: ["Cytoprotection assays", "Epithelial-barrier models", "Angiogenesis research"],
    specs: [
      { k: "Purity", v: "≥98% (HPLC)" },
      { k: "CAS", v: "137525-51-0" },
  ...
  },
  {
    ...
    panel: "#EEF1F3",
    blurb:
      "The synthetic active fragment of Thymosin β-4, used in actin-sequestration, angiogenesis and cell-migration research. Lyophilised, ≥98% pure, with a certificate of analysis in every vial.",
    research: ["Actin-sequestration studies", "Angiogenesis studies", "Cell-migration assays"],
    specs: [
      { k: "Purity", v: "≥98% (HPLC)" },
      { k: "CAS", v: "77591-33-4" },
  ...
  },
  {
    ...
    panel: "#E7ECEF",
    blurb:
      "Research-grade nicotinamide adenine dinucleotide for cellular-energetics and redox studies. Lyophilised, HPLC-verified and cold-chain shipped to protect stability in transit.",
